...
alter table "BeneficiariesHistory" add column "beneHistoryParentBeneficiary" varchar(255);
...
alter table "MedicareBeneficiaryIdHistory" add column "mbiParentBeneficiary" varchar(255);
